...
1. Microsoft SQL Server Management Studio içinde kaizen_case_Q1 isminde veritabanı oluşturun.
2. Yukarıdaki scriptleri sırasıyla **fmcg_code, generates_code, check_code** sırasıyla çalıştırın.
...
6. Kontrol procedure'e oluşanların dışında bir kod girerseniz 0 dönecektir, oluşanlar için 1 deönecektir.
